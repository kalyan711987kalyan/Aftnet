...
//    NSDictionary *param=[NSDictionary dictionaryWithObjectsAndKeys:@"kalyan",@"Username",@"kalyna7119",@"Password", nil];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        NSDictionary *subdict=[tempDict valueForKey:@"data"];
        
        NSMutableArray *kalyan=[subdict valueForKey:@"weather"];
        
        
       // NSLog(@"%@",[kalyan objectAtIndex:2]);
